            ...
            <header className={`Page__header`}>
                <Container>
                    <div className="Page__title">
                        ...
                        <Title heading={'p'} className={'Paragraph'}> Who am i? </Title>
                    </div>
                </Container>
            </header>
                    ...
                    <div className={Style.contacts__row}>
                        ...
                        <div className={Style.contacts__extra}>
                            ...
                            <div className={Style.contacts__item}>
                                ...
                                <Media icon={'x'} to={`https://twitter.com/khaetbekIT`} text='@khaetbekIT' />
                                <Media icon={'linkedin'} to={`https://www.linkedin.com/in/khaetbek`} text={`@khaetbek`} />
                                <Media icon={'vk'} to={`https://vk.com/khaetbekit`} text={`@khaetbekit`} />
                            </div>
            ...
            <section className={Style.contacts__media}>
                <Container>
                    ...
                    <div className={Style.media__row}>
                        ...
                        <Media icon={'linkedin'} to={`https://www.linkedin.com/in/khaetbek`} />
