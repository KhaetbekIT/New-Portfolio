      ...
      <main className="Home">
              ...
              <div className={Style.quote__row}>
                <div className={Style.quote__wrap}>
                  <ParallaxItem parallaxPosition={-10}>
                    <blockquote
                      className={`Title-2 ${Style.quote__blockquote}`}
                    >
                      With great power comes great electricity bill
                    </blockquote>
                    <div className={Style.quote__author}>- Dr. Who</div>
                  </ParallaxItem>
                </div>
              </div>
            </Container>
        ...
        <section className={Style.projects}>
          <Container>
            ...
            <Title
              heading={"h2"}
              className={`title-2 ${Style.projects__progress}`}
              hidden={IsLoading}
            >
              Downloading...
            </Title>
            ...
            <Container>
              ...
              <div className={Style.skills__row}>
                <div className={Style.skills__iconsholder}>
                  ...
                  <ParallaxItem
                    ...
                    className={`
                                        ...
                                        `}
                  >
                    <Image src={LogoOutline} srcSet={LogoOutline2} />
                  </ParallaxItem>
                ...
                <ul className={Style.skills__lists}>
                  ...
                  <li className={Style.skills__item_wrap}>
                    <div
                      className={`${Style.skills__item} ${Style.skills__item_big}`}
                    >
                      <Title heading="h3" className="Title-3">
                        Tools
                      </Title>
                ...
                <ul className={Style.contacts__list}>
                  <li>
                    <Media
                      icon={`telegram`}
                      text={`Khaetbek`}
                      to={"https://t.me/+998500796477"}
                    />
                  </li>
                  <li>
                    <Media
                      icon={`email`}
                      text={`Khaetbek@internet.ru`}
                      to={`mailto:khaetbek@internet.ru`}
                    />
                  </li>
                </ul>
              </div>
